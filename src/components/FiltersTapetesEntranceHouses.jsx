...
const FiltersTapetesEntranceHouses = () => {
    ...
    useEffect(() => {
        const applyFilters = () => {
            const filteredProducts = products.filter(product => {
                ...
                const usoMatch = selectedFilters.usoAplicacao.length === 0 ||
                    (product.uso && selectedFilters.usoAplicacao.includes(product.uso.aplicacao));
...
export default FiltersTapetesEntranceHouses;