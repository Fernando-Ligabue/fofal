...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center rounded-lg bg-zinc-100 p-1 text-fofalText dark:bg-zinc-800 dark:text-zinc-400",
      className
    )}
    {...props} />
))
