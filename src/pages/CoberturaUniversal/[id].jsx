        ...
        return (
            <section className="w-full min-h-[90vh] py-60 px-4">
                <div className="max-w-container mx-auto flex flex-col justify-between items-center gap-4">
                    <h3 className="w-full text-center font-brandon-800 text-4xl">Produto não encontrado.</h3>
                    <button className="border border-fofalText rounded-full font-brandon-400 py-2 px-6"
        ...
        <section className="w-full h-full py-40 p-4">
            <div className="max-w-container h-full md:min-h-[70vh] mx-auto pt-40 sm:p-4 flex flex-col md:flex-row justify-between items-stretch gap-10">
                ...
                <div className="w-full md:max-w-[50%] flex-flex-col justify-start items-start space-y-6 lg:px-10">
                    <span className="text-lg text-fofalText font-brandon-400">Loja</span>
                    <h2 className="text-3xl font-brandon-900">{product.title}</h2>
                    <p>{product.description}</p>
                    <p className="text-lg font-brandon-800">{product.price.toFixed(2)} €</p>
                    ...
                    <div>
                        {activeTab === 'caracteristicas' &&
                            <div className="flex flex-col gap-2 space-y-6 ">
                                <p className="font-brandon-500 text-lg text-fofalText">Tamanho: <span className="font-brandon-400">{product.size} - {product.dimensions}</span></p>
                                <p className="font-brandon-500 text-lg text-fofalText border-t border-fofalText pt-4">Informação Adicional <br /> <span className="font-brandon-400">{product.aditionalInfo}</span></p>
                            </div>
                        }
                    ...
                    <div className="w-full flex justify-start items-center gap-4">
                        <p className="font-brandon-500 text-lg text-fofalText">Quantidade</p>
