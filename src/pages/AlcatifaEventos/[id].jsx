...
import { calculateAlcatifas } from "@/lib/fnUtils.js/calculates";
            ...
            <div className="w-full max-w-full space-y-14">
              ...
              {activeTab === "caracteristicas" && (
                <div className="flex flex-col gap-2 space-y-6 ">
                  <p className="font-brandon-400 text-mdg text-fofalText" dangerouslySetInnerHTML={{ __html: product.features }}></p>
                </div>
              )}
              {activeTab === "informacoes" && (
                <div className="flex flex-col gap-2 space-y-6 ">
                  <p className="font-brandon-500 text-mdg text-fofalText" dangerouslySetInnerHTML={{ __html: product.customization }}></p>
                </div>
              )}
